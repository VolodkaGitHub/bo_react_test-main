export const error = {
  uk: {
    "error.email_format": "* Неправильний формат e-mail",
    "error.invalid_code": "* Неправильний код. Будь ласка, спробуйте ще раз",
    "error.invalid_code_format": "* Неправильний формат коду",
    "error.pass_required": "* Пароль є обов’язковим",
    "error.incorrect_email": "Неправильна адреса e-mail",
    "error.pass_different": "* Паролі не співпадають",
    "error.max": "* Сума перевищує допустимий ліміт",
    "error.min": "* Сума занадто мала."    
  },
  ...
  en: {
    ...
    "error.max": "*The amount exceeds the allowed limit",
    "error.min": "*The amount is too low",
  },
  ...
  ru: {
    ...
    "error.max": "*Сумма превышает допустимый лимит",
    "error.min": "*Сумма слишком мала.",
  },
